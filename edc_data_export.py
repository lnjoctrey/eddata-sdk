...
if args.provider == 'gcp':
    ...
    TABLES = ["user_card_performance_reporting_i_v", "group_performance_reporting_i_v", "channel_performance_reporting_i_v", "group_assignments_performance_i_v", "user_assignments_performance_i_v", "searches_fact_i_v", "assignments_fact_m_v", "badges_dim_m_v", "card_pack_relations_dim_m_v", "card_performance_hourly_rollups_i_v", "card_reportings_dim_m_v", "cards_dim_m_v", "channel_performance_hourly_rollups_i_v", "channels_cards_dim_m_v", "channels_dim_m_v", "comments_fact_m_v", "custom_fields_dim_m_v", "group_performance_hourly_rollups_i_v", "groups_dim_m_v", "journey_pack_relations_dim_m_v", "organizations_dim_m_v", "profiles_dim_m_v", "quizzes_fact_m_v", "roles_dim_m_v", "skills_users_dim_m_v", "structured_items_fact_m_v", "structures_dim_m_v", "team_assignments_fact_m_v", "teams_dim_m_v", "teams_users_fact_m_v", "user_content_completions_dim_m_v", "user_custom_fields_dim_m_v", "user_metrics_aggregations_fact_m_v", "user_onboardings_dim_m_v", "user_performance_hourly_rollups_i_v", "user_profiles_fact_m_v", "users_dim_m_v", "mkp_course_dim_m_v", "mkp_course_event_dim_m_v", "mkp_class_events_dim_m_v", "mkp_course_event_instructors_dim_m_v", "mkp_addresses_dim_m_v", "mkp_class_event_learners_dim_m_v", "mkp_users_dim_m_v", "mkp_agenda_item_attendances_dim_m_v", "mkp_agenda_items_dim_m_v", "mkp_course_event_reviews_dim_m_v", "mkp_course_event_buyer_specifications_dim_m_v", "mkp_certificate_template_dim_m_v", "mkp_certificate_dim_m_v", "mkp_custom_attendance_dim_m_v", "mkp_external_meeting_dim_m_v", "clcs_dim_m_v", "badgings_dim_m_v", "user_roles_dim_m_v", "card_custom_fields_dim_m_v", "taggings_dim_m_v", "job_family_roles_dim_m_v", "job_family_role_skills_dim_m_v", "user_job_family_roles_dim_m_v", "user_job_family_role_skills_dim_m_v", "skills_details_dim_m_v", "skill_assessments_dim_m_v", "skill_category_level_courses_dim_m_v", "timestamp_history_v", "dbt_eligibility_details_fact_i_v", "personal_details_fact_i_v","resources_dim_m_v", "mkp_revenue_report_info_m_v", "mkp_card_payment_report_info_m_v"]
